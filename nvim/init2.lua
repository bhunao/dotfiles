...
require('telescope').setup {
  defaults = {
    ...
    -- Enable teslescope fzf ==================
pcall(require('telescope').load_extension, 'fzf')
vim.keymap.set('n', '<leader>/', fuzzily_search, { desc = '[/] Fuzzily search in current buffer' })
...
vim.keymap.set('n', '<leader>t?', require('telescope.builtin').live_grep, { desc = '[S]earch current [W]ord' })
